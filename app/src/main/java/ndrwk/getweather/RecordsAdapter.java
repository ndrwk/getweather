...
//    public RecordsAdapter(Context context, IOnListItemClick callback, Record record){
//        super(context, callback);
//        mainListArray = Main.getCommandsList(category);
//    }
    ...
    public void onBindViewHolder(CommonListViewHolder holder, int position) {
        ...
        recordsViewHolder.values.setText(mainListArray.get(position).getValues());
    }
